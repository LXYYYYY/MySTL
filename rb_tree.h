...
{
	// re-tree的节点设计
	typedef bool re_tree_color_type;
	static constexpr re_tree_color_type rb_tree_red = false;
	static constexpr re_tree_color_type rb_tree_black = true;
	...
	struct rb_tree_value_traits_imp<T,true>
	{
		...
		typedef typename T::sceond_type									mapped_type;
		typedef T														value_type;
	...
	// 
	// 参考博客: http://blog.csdn.net/v_JULY_v/article/details/6105630
	//          http://blog.csdn.net/v_JULY_v/article/details/6109153z
	template <class NodePtr>
